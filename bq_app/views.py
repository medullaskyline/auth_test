...
import time
import os
from oauth2client.client import GoogleCredentials, AccessTokenRefreshError, ApplicationDefaultCredentialsError  #, flow_from_clientsecrets, SignedJwtAssertionCredentials,
...
def queryTable(service, projectId, datasetId, destinationTableId, queryStr, http=None):
    try:
        print 'jobCollection = service.jobs()'
...
def authorize_credentials_with_Google():
    ...
    try:
        ...
        # get_application_default() checks existence of implicit credentials from these sources, in order:
        # 1. GAE
        # 2. files
        # 2.a GOOGLE_APPLICATION_CREDENTIALS file
        # 2.b. application_default_credentials.json file generated by gcloud auth login in GCE
        # 3. GCE
        print '\nget_application_default()'
    except ApplicationDefaultCredentialsError as err:
        print err
        try:
            # from_stream() just checks for a GOOGLE_APPLICATION_CREDENTIALS file
    ...
    print 'between credentials.authorize and service = build()'
